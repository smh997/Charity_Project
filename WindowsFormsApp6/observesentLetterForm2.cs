...
{
    public partial class observesentLetterForm2 : Form
    {
        string connection = "Data Source=DESKTOP-S1F0LH1;Initial Catalog=kheirie;Integrated Security=True";
        string id;
        public observesentLetterForm2(string id)
        {
            InitializeComponent();
            this.id = id;
        }

        private void observesentLetterForm2_Load(object sender, EventArgs e)
        {
            ...
            cmd2 = new SqlCommand("select id as 'شماره نامه', title as 'عنوان', receiver as 'گیرنده', signer as 'امضاکننده', attachment as 'پیوست', dbo.MiladiTOShamsi(senddate) as 'تاریخ ارسال', dbo.MiladiTOShamsi(subdate) as 'تاریخ ثبت', enactmentId as 'شماره مصوبه' from sendingLettersHistory where id = @id;", con1);
