...
namespace WindowsFormsApp6
{
    public partial class observeabandonedsForm2 : Form
    {
        ...
        private void enterButton_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(this.connection);
            con.Open();
            SqlCommand cmdget = new SqlCommand("select enactmentId from abandoned where id = @id;", con);
        ...
        private void docButton_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select setupdate from abandoned, outmember where abandoned.id = outmember.id and abandoneddate = setupdate and supporter_id = outmember.id and abandoned.id = supporter_id and outmember.id = @id", con);
            ...
            con.Close();
            var newform = new observeDocForm("ویرایش مدارک حذف", "deletion", this.id, dt.ToString());
            newform.ShowDialog(this);
        }
