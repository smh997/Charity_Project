...
{
    public partial class observeabandonedsForm : Form
    {
        string connection = "Data Source=DESKTOP-S1F0LH1;Initial Catalog=kheirie;Integrated Security=True";
        public observeabandonedsForm()
        {
            InitializeComponent();
        }

        private void observeabandonedsForm_Load(object sender, EventArgs e)
        {
        ...
        private void nameTextbox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                this.observeabandonedsForm_Load(sender, e);
            }
        }
        ...
        {
            var newform = new observeabandonedsForm2(ExtensionFunction.PersianToEnglish(membersView.Rows[membersView.SelectedCells[0].RowIndex].Cells[membersView.SelectedCells[0].ColumnIndex].Value.ToString()));
