...
{
    public partial class observehelpersForm : Form
    {
        string connection = "Data Source=DESKTOP-S1F0LH1;Initial Catalog=kheirie;Integrated Security=True";
        public observehelpersForm()
        {
            InitializeComponent();
        }

        private void observehelpersForm_Load(object sender, EventArgs e)
        {
        ...
        private void nameTextbox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                this.observehelpersForm_Load(sender, e);
            }
        }
        ...
        {
            var newform = new observehelpersForm2(ExtensionFunction.PersianToEnglish(membersView.Rows[membersView.SelectedCells[0].RowIndex].Cells[membersView.SelectedCells[0].ColumnIndex].Value.ToString()));
