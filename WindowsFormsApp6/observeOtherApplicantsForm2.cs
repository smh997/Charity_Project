...
{
    public partial class observeOtherApplicantsForm2 : Form
    {
        string id;
        string connection = "Data Source=DESKTOP-S1F0LH1;Initial Catalog=kheirie;Integrated Security=True";
        public observeOtherApplicantsForm2(string id)
        {
            InitializeComponent();
            this.id = id;
        }

        private void observeOtherApplicantsForm2_Load(object sender, EventArgs e)
        {
            SqlConnection con1 = new SqlConnection(this.connection);
            con1.Open();
            SqlCommand cmd2; SqlDataAdapter da; DataTable dt;
            cmd2 = new SqlCommand("select id as 'شماره ملی', name as نام, family as 'نام خانوادگی', dbo.MiladiTOShamsi(subdate)as 'تاریخ عضویت', phone as 'شماره تلفن', address as آدرس, explain as توضیحات from otherApplicant where id = @id;", con1);
