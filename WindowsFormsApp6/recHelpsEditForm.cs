...
{
    public partial class recHelpsEditForm : Form
    {
        public recHelpsEditForm()
        {
            InitializeComponent();
        }
        ...
        {
            var newform = new searchForm("ویرایش کمک دریافتی");
        ...
        {
            var newform = new recHelpsEditForm2(ExtensionFunction.PersianToEnglish(idTextbox.Text));
            newform.ShowDialog(this);
        }

        private void recHelpsEditForm_Load(object sender, EventArgs e)
        {
