...
namespace WindowsFormsApp6
{
    public partial class observeFamiliesForm2 : Form
    {
        ...
        {
            var newform = new observeDocForm("ورود", "enter", this.id);
            newform.ShowDialog(this);
        }
