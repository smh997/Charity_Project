...
{
    public partial class observeEnactmentsForm : Form
    {
        string connection = "Data Source=DESKTOP-S1F0LH1;Initial Catalog=kheirie;Integrated Security=True";
        public observeEnactmentsForm()
        {
            InitializeComponent();
        }

        private void observeEnactmentsForm_Load(object sender, EventArgs e)
        {
            ...
            cmd2 = new SqlCommand("select id as 'شناسه', dbo.MiladiTOShamsi(setdate) as 'تاریخ', docname as 'نام فایل' , docpath from enactment;", con1);
            da = new SqlDataAdapter(cmd2);
            dt = new DataTable();
            da.Fill(dt);
            membersView.DataSource = dt;
            membersView.Columns[3].Visible = false;
        ...
        private void searchButton_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("select id as 'شناسه', dbo.MiladiTOShamsi(setdate) as 'تاریخ', docname as 'نام فایل' , docpath from enactment where setdate >= '" + startDateTimePickerX.SelectedDateInStringEnglish + "' and setdate <= '" + endDateTimePickerX.SelectedDateInStringEnglish + "';", con1);
        ...
        {
            string dpath = membersView.Rows[membersView.SelectedCells[0].RowIndex].Cells[membersView.SelectedCells[0].ColumnIndex + 3].Value.ToString();
