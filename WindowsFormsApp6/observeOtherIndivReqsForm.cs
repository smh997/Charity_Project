...
{
    public partial class observeOtherIndivReqsForm : Form
    {
        string connection = "Data Source=DESKTOP-S1F0LH1;Initial Catalog=kheirie;Integrated Security=True";
        public observeOtherIndivReqsForm()
        {
            InitializeComponent();
        }

        private void observeOtherIndivReqsForm_Load(object sender, EventArgs e)
        {
            chooseButton.Enabled = exportButton2.Enabled = false;
            SqlConnection con = new SqlConnection(this.connection);
            con.Open();
            SqlCommand cmd2; SqlDataAdapter da; DataTable dt;
            cmd2 = new SqlCommand("select id as 'شماره درخواست کمک', mId as 'شماره ملی متقاضی', status as 'وضعیت', dbo.MiladiTOShamsi(subdate) as 'تاریخ ثبت', dbo.MiladiTOShamsi(reqdate) as 'تاریخ درخواست', enactmentId as 'شماره مصوبه', description as 'توضیحات' from OtherHelpIndivReq;", con);
        ...
        private void searchButton_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("select id as 'شماره درخواست کمک', mId as 'شماره ملی متقاضی', status as 'وضعیت', dbo.MiladiTOShamsi(subdate) as 'تاریخ ثبت', dbo.MiladiTOShamsi(reqdate) as 'تاریخ درخواست', enactmentId as 'شماره مصوبه', description as 'توضیحات' from OtherHelpIndivReq where " + ss + ";", con1);
        ...
        {
            var newform = new observeOtherIndivReqsForm2(ExtensionFunction.PersianToEnglish(membersView.Rows[membersView.SelectedCells[0].RowIndex].Cells[membersView.SelectedCells[0].ColumnIndex].Value.ToString()));
