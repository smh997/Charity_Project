...
namespace WindowsFormsApp6
{
    public partial class observeHealHelpsForm2 : Form
    {
        ...
        {        
            var newform = new observeHealReqsForm2(ExtensionFunction.PersianToEnglish(membersView.Rows[membersView.SelectedCells[0].RowIndex].Cells[membersView.SelectedCells[0].ColumnIndex+1].Value.ToString()));
        ...
        private void receiptButton_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(this.connection);
            con.Open();
            SqlCommand cmd = new SqlCommand("select docpath from doc where id = @id and doctype = 'Hhelp:receipt';", con);
