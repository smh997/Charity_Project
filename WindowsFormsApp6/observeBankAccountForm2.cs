...
{
    public partial class observeBankAccountForm2 : Form
    {
        string id;
        string connection = "Data Source=DESKTOP-S1F0LH1;Initial Catalog=kheirie;Integrated Security=True";
        public observeBankAccountForm2(string id)
        {
            InitializeComponent();
            this.id = id;
        }

        private void observeBankAccountForm2_Load(object sender, EventArgs e)
        {
            SqlConnection con1 = new SqlConnection(this.connection);
            con1.Open();
            SqlCommand cmd2; SqlDataAdapter da; DataTable dt;
            cmd2 = new SqlCommand("select id as 'شماره حساب', name as نام, bankName as 'نام بانک', ownerName as 'نام صاحب حساب', enactmentId as 'شماره مصوبه', description as 'توضیحات', subdate as 'تاریخ ثبت' from backAccountInfoHistory where id = @id;", con1);
