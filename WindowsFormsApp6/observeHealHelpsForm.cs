...
{
    public partial class observeHealHelpsForm : Form
    {
        string connection = "Data Source=DESKTOP-S1F0LH1;Initial Catalog=kheirie;Integrated Security=True";
        public observeHealHelpsForm()
        {
            InitializeComponent();
        }

        private void observeHealHelpsForm_Load(object sender, EventArgs e)
        {
            ...
            cmd2 = new SqlCommand("select id as 'شماره کمک', reqId as 'شماره درخواست', dbo.MiladiTOShamsi(subdate) as 'تاریخ ثبت', dbo.MiladiTOShamsi(enddate) as 'تاریخ ارائه', dbo.MiladiTOShamsi(confirmdate) as 'تاریخ تایید', cast(fee as decimal(15,0)) as 'ارزش ریالی', status as 'وضعیت', bankAccountName as 'نام حساب', bankAccountId as 'شماره حساب', enactmentId as 'شماره مصوبه تعریف', fenactmentId as 'شماره مصوبه تایید', description as 'توضیحات کمک', presdescription as 'توضیحات ارائه', confirmdescription as 'توضیحات تایید' from HealHelps;", con);
        ...
        private void searchButton_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("select id as 'شماره کمک', reqId as 'شماره درخواست', dbo.MiladiTOShamsi(subdate) as 'تاریخ ثبت', dbo.MiladiTOShamsi(enddate) as 'تاریخ ارائه', dbo.MiladiTOShamsi(confirmdate) as 'تاریخ تایید', cast(fee as decimal(15,0)) as 'ارزش ریالی', status as 'وضعیت', bankAccountName as 'نام حساب', bankAccountId as 'شماره حساب', enactmentId as 'شماره مصوبه تعریف', fenactmentId as 'شماره مصوبه تایید', description as 'توضیحات کمک', presdescription as 'توضیحات ارائه', confirmdescription as 'توضیحات تایید' from HealHelps where " + ss + ";", con1);
        ...
        {
            var newform = new observeHealHelpsForm2(ExtensionFunction.PersianToEnglish(membersView.Rows[membersView.SelectedCells[0].RowIndex].Cells[membersView.SelectedCells[0].ColumnIndex].Value.ToString()));
