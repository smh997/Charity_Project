...
{
    public partial class observeGlobalHelpsForm2 : Form
    {
        string connection = "Data Source=DESKTOP-S1F0LH1;Initial Catalog=kheirie;Integrated Security=True";
        string id;
        public observeGlobalHelpsForm2(string id)
        {
            InitializeComponent();
            this.id = id;
        }

        private void observeGlobalHelpsForm2_Load(object sender, EventArgs e)
        {
            ...
            // tmp
            cmd2 = new SqlCommand("select gId as 'شماره کمک', supporter_id as 'شماره ملی سرپرست', mId as 'شماره ملی', folder_id as 'شماره پرونده', name as 'نام', family as 'نام خانودگی', fatherName as 'نام پدر', packets as 'تعداد بسته', rate as 'امتیاز' from tmpDefinedTableHelp where gId = @id;", con);
            ...
            // fin
            cmd2 = new SqlCommand("select gId as 'شماره کمک', supporter_id as 'شماره ملی سرپرست', mId as 'شماره ملی', folder_id as 'شماره پرونده', name as 'نام', family as 'نام خانودگی', fatherName as 'نام پدر', packets as 'تعداد بسته', rate as 'امتیاز' from finalizedTableHelp where gId = @id;", con);
            cmd2.Parameters.AddWithValue("@id", this.id);
            da = new SqlDataAdapter(cmd2);
            dt = new DataTable();
            da.Fill(dt);
            ...
            // del
            cmd2 = new SqlCommand("select gId as 'شماره کمک', supporter_id as 'شماره ملی سرپرست', mId as 'شماره ملی', folder_id as 'شماره پرونده', name as 'نام', family as 'نام خانودگی', fatherName as 'نام پدر', packets as 'تعداد بسته', rate as 'امتیاز' from delDefinedTableHelp where gId = @id;", con);
            cmd2.Parameters.AddWithValue("@id", this.id);
            da = new SqlDataAdapter(cmd2);
            dt = new DataTable();
            da.Fill(dt);
            ...
            // notcome
            cmd2 = new SqlCommand("select gId as 'شماره کمک', supporter_id as 'شماره ملی سرپرست', mId as 'شماره ملی', folder_id as 'شماره پرونده', name as 'نام', family as 'نام خانودگی', fatherName as 'نام پدر', packets as 'تعداد بسته', rate as 'امتیاز' from notexistTableHelp where gId = @id;", con);
            cmd2.Parameters.AddWithValue("@id", this.id);
            da = new SqlDataAdapter(cmd2);
            dt = new DataTable();
            da.Fill(dt);
            ...
            // rec
            cmd2 = new SqlCommand("select gId as 'شماره کمک', supporter_id as 'شماره ملی سرپرست', mId as 'شماره ملی', folder_id as 'شماره پرونده', name as 'نام', family as 'نام خانودگی', fatherName as 'نام پدر', packets as 'تعداد بسته', rate as 'امتیاز' from receivedTableHelp where gId = @id;", con);
            cmd2.Parameters.AddWithValue("@id", this.id);
            da = new SqlDataAdapter(cmd2);
            dt = new DataTable();
            da.Fill(dt);
        ...
        private void finExportButton2_Click(object sender, EventArgs e)
        {
            ...
            for (int j = 0; j < finDataGridView.Columns.Count; j++)
            {
                if (finDataGridView.Rows[finDataGridView.SelectedCells[0].RowIndex].Cells[j].Value.GetType().ToString() == "System.DateTime")
                {
                    worksheet.Cells[2, j + 1] = ExtensionFunction.ToPersian(Convert.ToDateTime(finDataGridView.Rows[finDataGridView.SelectedCells[0].RowIndex].Cells[j].Value.ToString()));
                }
                else
                {
                    worksheet.Cells[2, j + 1] = finDataGridView.Rows[finDataGridView.SelectedCells[0].RowIndex].Cells[j].Value.ToString();
                }
            }
            // see the excel sheet behind the program  
            app.Visible = true;
        ...
        private void chooseButton_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(this.connection);
            con.Open();
            SqlCommand cmd = new SqlCommand("select docpath from doc where id = @id and doctype = 'Ghelp';", con);
